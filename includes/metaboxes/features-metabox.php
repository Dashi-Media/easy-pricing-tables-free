...
<div id="dh_ptp_tabs_container" style="display: none;" class="my_meta_control">
    <ul id="dh_ptp_metabox_tabs">
        <li class="dh_ptp_tab_header"><a href="#dh_ptp_tabs_2"><?php _e('Template', 'easy-pricing-tables'); ?></a></li>
        <li class="dh_ptp_tab_header"><a href="#dh_ptp_tabs_1"><?php _e('Content', 'easy-pricing-tables'); ?></a></li>
        <li class="dh_ptp_tab_header"><a href="#dh_ptp_tabs_3"><?php _e('Design', 'easy-pricing-tables'); ?></a></li>
    </ul>
    ...
    <div id="ptp-save-buttons">
        <div style="margin-left:10px;margin-right:10px;">
            ...
            <a style="float:left;" class="button button-large" id="save_preview" data-url="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php _e('Save & Preview', 'easy-pricing-tables'); ?></a>
            <input style="float:left; margin-left:10px;" name="save" id="save" type="submit" class="button button-large" accesskey="p" value="<?php _e('Save', 'easy-pricing-tables'); ?>" />
    ...
    <div style='display:none'>
        <div id='deploy' style='padding:10px; background:#fff;'>
            <p><?php _e('Copy the shortcode below and paste it wherever you want your pricing table to appear.', 'easy-pricing-tables'); ?></p>
