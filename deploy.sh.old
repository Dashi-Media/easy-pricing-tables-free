...
# main config
#PLUGINSLUG=${PWD##*/} # returns basename of current directory (edited)
PLUGINSLUG="easy-pricing-tables"
CURRENTDIR=`pwd`
MAINFILE="pricing-table-plugin.php" # this should be the name of your main php file in the wordpress plugin (edited)
...
SVNUSER="davidhme" # your svn username (edited)
